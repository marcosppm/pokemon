...
public class Battle extends Controller {
	...
	private void prepareBattle() {
		...
		player1Pokemons[5] = new Pokemon("Bulbasaur", 500, attacksBulbasaur, AttackType.GRASS);
		...
		player1Pokemons[4] = new Pokemon("Charmander", 500, attacksCharmander, AttackType.FIRE);
		...
		player1Pokemons[3] = new Pokemon("Sandslash", 500, attacksSandslash, AttackType.GROUND);
		
		Attack[] attacksPidgey = new Attack[1];
		attacksPidgey[0] = new Attack("Gust", AttackType.FLYING, 40, 0);
		player1Pokemons[2] = new Pokemon("Pidgey", 500, attacksPidgey, AttackType.FLYING);
		...
		player1Pokemons[1] = new Pokemon("Pikachu", 500, attacksPikachu, AttackType.ELECTRIC);
		...
		player1Pokemons[0] = new Pokemon("Squirtle", 500, attacksSquirtle, AttackType.WATER);
